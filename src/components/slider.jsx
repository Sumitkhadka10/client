                ...
                <Col xs={2}>
                  <div className="slider-buttons d-grid mt-5">
                    <Button
                      ...
                      onClick={onNextClick}
                      className="next-button secondary-bg-color border-0 rounded-0"
                      size="lg"
                    >
                      <GrNext />
                    </Button>
                    <Button
                      variant="outline-dark"
                      onClick={onPrevClick}
                      className="prev-button primary-bg-color border-0 rounded-0"
                      size="lg"
                    >
                      <GrPrevious />
                    </Button>
                    ...
                    <Carousel.Item interval={3000}>
                      <Carousel.Caption className="carousel-caption text-dark text-start">
                        <h2 className="fs-1 fw-bold mb-2">
                          <span>Car Rent</span>
                          <br />
                          <span className="primary-color">For You</span>
                        </h2>
                      </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item interval={3000}>
                      <Carousel.Caption className="carousel-caption text-dark text-start">
                        <h2 className="fs-1 fw-bold mb-2">
                          ...
                          <br />
                          <span className="primary-color">Easy</span>
                        </h2>
                      </Carousel.Caption>
                    </Carousel.Item>
                  </Carousel>
